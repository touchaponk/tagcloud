...
Pass the id of HTML element what you want to generate tagcloud into.  
...
If you use Prototype.js, It'll be further simple code.
...
The example HTML that this libary finally generate will be like follow format.
...
This effector change style of tag it's name
